...
export default {
  ...
  methods: {
    getAriticle () {
      axios
        .get(`${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/articles`)
        .then((res) => {
    ...
    openEditModla (item) {
      ...
      axios
        .get(
          `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/article/${item.id}`
        )
        .then((res) => {
    ...
    newArticle () {
      if (this.modal === true) {
        ...
        axios
          .post(
            `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/article`,
            { data }
          )
          .then((res) => {
            if (res.success === true) {
        ...
        axios
          .put(
            `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/article/${this.dataId}`,
            { data }
          )
          .then((res) => {
            if (res.success === true) {
    ...
    delArticle (id) {
      axios
        .delete(
          `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/article/${id}`
        )
        .then((res) => {
          this.getAriticle()
          Swal.fire(`${res.data.message}`)
