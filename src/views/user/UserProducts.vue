      ...
      <tbody>
        <tr v-for="product in products" :key="product.id">
          ...
          <td>
            <div class="btn-group">
              <button
                @click="editProductModal(product, product.id)"
                type="button"
...
export default {
  ...
  methods: {
    getProducts (page = 1) {
      axios
        .get(
          `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/products/?page=${page}`
        )
        .then((res) => {
    ...
    deleteProduct () {
      ...
      axios
        .delete(
          `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/product/${id}`
        )
        .then((res) => {
    ...
    addPorduct () {
      ...
      if (this.changeModal === true) {
        ...
        axios
          .post(
            `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/product`,
            { data }
          )
          .then((res) => {
            if (res.success === true) {
