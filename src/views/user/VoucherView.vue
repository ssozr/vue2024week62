<template>
  <div class="container">
    <div class="text-end my-4">
      <button type="button" class="btn btn-primary" @click="openCouponMadl()">
        建立優惠券
      </button>
    </div>
    <table class="table">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <button
              ...
              @click="percentValue(1)"
              :disabled="couponData.percent === 100"
            >
              +1
            </button>
            <button
              ...
              @click="percentValue(10)"
              :disabled="couponData.percent > 90"
            >
              +10
            </button>
            <input
            ...
            <button
              ...
              @click="percentValue(-10)"
              :disabled="couponData.percent < 10"
            >
              -10
            </button>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="newCoupon()">
            確定
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getCoupons (page = 1) {
      axios
        .get(
          `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/coupons?page=${page}`
        )
        .then((res) => {
    ...
    newCoupon () {
      ...
      if (this.modal === false) {
        ...
        axios
          .put(
            `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/coupon/${this.editId}`,
            { data }
          )
          .then((res) => {
            this.getCoupons()
        ...
        axios
          .post(
            `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/coupon`,
            { data }
          )
          .then((res) => {
            if (res.data.success === true) {
    ...
    delCoupon () {
      ...
      axios
        .delete(
          `${VITE_APP_API_URL}/v2/api/${VITE_APP_API_NAME}/admin/coupon/${this.delId}`
        )
        .then((res) => {
          Swal.fire(`${res.data.message}`)
          this.getCoupons()
